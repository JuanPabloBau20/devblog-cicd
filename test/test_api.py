...
class TestAPIEndpoints:
    ...
    def test_get_all_posts_success(self, client):
        """GET /api/posts devuelve todos los posts en formato JSON"""
    ...
    def test_get_single_post_success(self, client):
        """GET /api/posts/<id> devuelve un post específico"""
    ...
    def test_get_single_post_not_found(self, client):
        """GET /api/posts/<id> con ID inexistente devuelve 404"""
    ...
    def test_create_post_success(self, client):
        """POST /api/posts crea un nuevo post correctamente"""
        new_post = {
    ...
    def test_create_post_missing_data(self, client):
        """POST /api/posts sin datos requeridos devuelve error"""
    ...
    def test_create_post_no_json(self, client):
        """POST /api/posts sin JSON devuelve error"""
    ...
    def test_create_post_invalid_json(self, client):
        """POST /api/posts con JSON malformado devuelve error"""
        response = client.post(
            '/api/posts',
    ...
    def test_update_post_success(self, client):
        """PUT /api/posts/<id> actualiza un post correctamente"""
        update_data = {
    ...
    def test_update_post_not_found(self, client):
        """PUT /api/posts/<id> con ID inexistente devuelve 404"""
    ...
    def test_delete_post_success(self, client):
        """DELETE /api/posts/<id> elimina un post correctamente"""
    ...
    def test_delete_post_not_found(self, client):
        """DELETE /api/posts/<id> con ID inexistente devuelve 404"""
    ...
    def test_search_api_success(self, client):
        """GET /api/search?q=término busca posts correctamente"""
        ...
        for post in data['data']:
            assert 'docker' in post['title'].lower() or 'docker' in post['content'].lower()

    def test_search_api_no_query(self, client):
        """GET /api/search sin parámetro q devuelve error"""
    ...
    def test_search_api_empty_query(self, client):
        """GET /api/search?q= (vacío) devuelve error"""
    ...
    def test_search_api_no_results(self, client):
        """GET /api/search con término que no existe"""
